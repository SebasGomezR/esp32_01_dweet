...
const char *ssid = "*KIRITO*";
const char *password = "12281018KB";
...
void loop()
{
  ...
  String url = "/dweet/for/ucevaSGR?temperatura=" + String(temperatura) + "&humedad=" + String(humedad) + "&indice=" + String(indice);
